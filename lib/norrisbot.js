...
NorrisBot.prototype._customMessages = function (originalMessage) {
    ...
    var keyResponseDict = {
        "cake": "Baker Street!?",
        "christmas" : christmasDetection(),
        "xmas" : christmasDetection(),
        "santa" : christmasDetection(),
    };
...
function christmasDetection() {
    ...
    if (n < 12) {
        return "I'm sorry?, are we talking about christmas outside of December?";
    } else {
        return "Oh, you mean it's actually Christmas. Did you bring your gun as I suggested?";
    }
